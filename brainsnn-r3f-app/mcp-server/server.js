...
const TOOLS = [
  ...
  { name: 'test_hypothesis', description: 'Layer 62 — structured belief testing across evidence items.', inputSchema: { type: 'object', properties: { hypothesis: { type: 'string' }, evidence: { type: 'string' } }, required: ['hypothesis', 'evidence'] } },
