...
const OperationsWorkspace = React.lazy(() => import('../features/ops/OperationsWorkspace.jsx').then((module) => ({ default: module.OperationsWorkspace })));
