...
export function RewriteControls({ goal, onGoalChange, onGenerate }) {
  return (
    <section className="rewrite-controls" aria-labelledby="rewrite-controls-heading">
      <div className="bsn-section-head">
        ...
        <Button variant="primary" onClick={onGenerate}><Wand2 size={16} aria-hidden="true" /> Generate rewrite</Button>
      </div>
      <SegmentedControl
        label=""
        value={goal}
