        ...
        <section className="main-column">
          ...
          <div className="app-section" hidden={activeSection !== "firewall"}>
            ...
            <CognitiveFirewallPanel
              ...
              onApplyToNetwork={(result) => {
                ...
                toastWarning(
                  `Firewall: ${result.recommendedAction.slice(0, 60)}...`,
                );
              }}
            />
            ...
            <ErrorBoundary name="Brain Evolve">
              <BrainEvolvePanel
                onPromote={(node) => {
                  ...
                  toastSuccess(
                    `Evolved firewall promoted (F1 ${f1.toFixed(3)})`,
                  );
                }}
              />
            </ErrorBoundary>
            ...
            <ErrorBoundary name="Attack Evolve">
              <AttackEvolvePanel
                onAttackPromoted={(node, category) => {
                  ...
                  const evasion = ((1 - (node.detection || 0)) * 100).toFixed(
                    0,
                  );
                  recordImmunity(IMMUNITY_EVENTS.KNOWLEDGE_SCANNED, {
          ...
          <div className="app-section" hidden={activeSection !== "io"}>
            ...
            <PluginPanel
              onApplyResults={(combined) => {
                ...
                const mapped = {
                  ...
                  trustErosion:
                    combined.negativity ?? combined.trustErosion ?? 0,
                };
            ...
            <section className="panel panel-pad deploy-panel">
              ...
              <p className="muted">
                This project includes deployment configs plus browser-side
                export helpers for shareable demos.
              </p>
            </section>
          </div>
        </section>
