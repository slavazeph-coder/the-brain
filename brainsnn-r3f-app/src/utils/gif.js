// @ffmpeg is loaded lazily — only when the user actually exports a GIF — so
// its JS glue stays out of the initial bundle. (The WASM core already loads
// from CDN at runtime below.) import() is module-cached, so the second
// @ffmpeg/util import in convertWebMBlobToGif is free.
...
export async function convertWebMBlobToGif(
  blob,
  options = {},
  onProgress,
  onStatus,
