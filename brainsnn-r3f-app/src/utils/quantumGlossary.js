/**
 * Layer 104 — Quantum Glossary data.
 *
 * Plain-data module so the term list is testable in plain Node without a
 * JSX runtime. The L104 panel renders this; eml.test / glossary.test pin
 * the structure.
 */
...
export const GLOSSARY_TERMS = [
  ...
  },
  {
    ...
    category: 'gate',
    plain: 'A small fixed family of gates from which any unitary can be approximated to any precision.',
    math: 'e.g. {H, CNOT, T} (Solovay–Kitaev). Classical analog: NAND. Continuous-math analog: eml(x,y)=exp(x)−ln(y), Odrzywołek arXiv:2603.21852.',
    metaphor: 'A LEGO kit of three pieces that can build any shape if you snap enough together.',
  },
];

export const GLOSSARY_CATEGORY_LABEL = {
  state: 'States',
  gate: 'Gates',
  process: 'Processes',
  noise: 'Noise',
...
export const GLOSSARY_CATEGORY_COLOR = {
  state: '#5ad4ff',
  gate: '#a86fdf',
  process: '#fdab43',
  noise: '#dd6974',
...
export function searchGlossary(terms, query, category = 'all') {
